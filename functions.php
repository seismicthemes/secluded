...
function secluded_setup() {
	...
	load_theme_textdomain( 'secluded', get_template_directory() . '/languages' );
...
function theme_scripts() {
	wp_enqueue_style('secluded-style', get_bloginfo('stylesheet_url'), false, '0.1');
